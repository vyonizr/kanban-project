...
const TaskForm = ({
  ...
  const [title, setTitle] = useState<string>(
    task !== undefined && type === TASK_MODAL_TYPE.EDIT ? task.title : ""
  );
  const [detail, setDetail] = useState<string>(
    task !== undefined && type === TASK_MODAL_TYPE.EDIT ? task.detail : ""
  );
  const [dueDate, setDueDate] = useState<string>(
    task !== undefined && type === TASK_MODAL_TYPE.EDIT ? task.dueDate : ""
  );
  const [progressOrder, setProgressOrder] =
    useState<number>(defaultProgressOrder);
